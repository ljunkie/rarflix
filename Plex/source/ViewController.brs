...
Sub vcShowReleaseNotes(options = invalid)
    ...
    if NOT textScreen then 
        ...
        paragraphs.Push("  ")
        paragraphs.Push(us+"v3.1.20-internal (2014-02-14)"+us)
        paragraphs.Push("  ")
        paragraphs.Push(" * slide show completely rewritten (testing)")
        paragraphs.Push(" * lazy load photo sections on the grid")
        paragraphs.Push(" * many other fixes/addition -- explain when released (TODO)")
        paragraphs.Push("  ")

        paragraphs.Push("  ")
        paragraphs.Push(us+"v3.1.3-DEV (2014-01-15)"+us)
        paragraphs.Push("  ")
        paragraphs.Push(" * potential slowdown when using myPlex+local PMS not requiring authentication")
        paragraphs.Push(" * still function/start when myPlex is down - Use the last 'known' myPlex found server(s)")
        paragraphs.Push(" * tv section grid speed-ups -- regression caused by TV Season posters")
        paragraphs.Push("  ")

        paragraphs.Push("  ")
        paragraphs.Push(us+"v3.1.2 (2014-01-13)"+us)
        paragraphs.Push("  ")
