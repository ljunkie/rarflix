...
Sub vcShowReleaseNotes()
    ...
    paragraphs.Push(" - Swapped the order of Play/Resume so that Resume is focused.")
    paragraphs.Push(" - Switch to the new transcoder with recent server versions.")
    paragraphs.Push(" - Try to improve video loading times.")
    paragraphs.Push(" - Fix a few crashes, including one during audio playback.")
